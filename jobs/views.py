...
# job list filtering 
    job_type = request.GET.get('job_type') # it will get request from browser in filter box 
...
# pagination 
    ...
    return render(request,'jobs/job_list.html', {'jobs':page_obj,'page_obj':page_obj,'job_type':job_type,'location':location},)
